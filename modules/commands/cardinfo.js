...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`http://api.leanhtruong.net/api/info?api_key=leanhtruong_R6BvUGNLFtLLmyt2ADpD&id=${uid}`); 
  let getAvatarOne = (await axios.get(`https://graph.facebook.com/${uid}/picture?height=720&width=720&access_token=613069889896486|LgZ0UInoo-IdDfNmKQ2kggbyI_4`, { responseType: 'arraybuffer' })).data;
  let bg = (
